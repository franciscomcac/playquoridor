...
export function play(name: SfxName) {
  ...
  switch (name) {
    ...
    case "wall":
      ...
      break;
    case "join":
      beep({ freq: 520, dur: 0.09, type: "triangle", vol: 0.32 });
      beep({ freq: 780, dur: 0.11, type: "triangle", vol: 0.32, delay: 0.09 });
      break;
    case "matchStart":
      [523.25, 659.25, 783.99].forEach((f, i) =>
        beep({ freq: f, dur: 0.16, type: "triangle", vol: 0.32, delay: i * 0.09 }),
      );
      break;
    case "roundWin":
      [523.25, 659.25, 783.99, 1046.5].forEach((f, i) =>
        beep({ freq: f, dur: 0.15, vol: 0.35, delay: i * 0.08 }),
      );
      break;
    case "matchWin":
      [523.25, 659.25, 783.99, 1046.5, 1318.5].forEach((f, i) =>
        beep({ freq: f, dur: 0.2, type: "triangle", vol: 0.38, delay: i * 0.1 }),
      );
      beep({ freq: 1760, dur: 0.35, vol: 0.25, delay: 0.55 });
      break;
    case "afkWarn":
      beep({ freq: 660, dur: 0.14, type: "square", vol: 0.3 });
      beep({ freq: 660, dur: 0.14, type: "square", vol: 0.3, delay: 0.22 });
      break;
    case "click":
      beep({ freq: 1200, dur: 0.04, vol: 0.22 });
      break;
