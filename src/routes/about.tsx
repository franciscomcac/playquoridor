          ...
          mainEntity: [
            {
              ...
              acceptedAnswer: {
                "@type": "Answer",
                text: "Yes. Many players remember Quoridor by its components — round pawns and wall segments — and search for it as the balls and walls game or the wall blocking board game. It is called Quoridor.",
              },
            },
            {
              "@type": "Question",
              ...
              acceptedAnswer: {
                "@type": "Answer",
                text: "9×9 Quoridor has not been formally solved. Smaller 5×5 variants have been computer-solved and are a first-player win with perfect play. On the full 9×9 board strong engines exist but the game remains rich for human play.",
              },
            },
            {
              "@type": "Question",
              ...
              acceptedAnswer: {
                "@type": "Answer",
                text: "No. On every turn you choose freely between moving your pawn and placing a wall. You can play an entire game without placing a wall — you just usually won't win against a player who does.",
              },
            },
            {
              "@type": "Question",
              ...
              acceptedAnswer: {
                "@type": "Answer",
                text: "No. After any wall placement, every player must still have at least one legal path to their goal. A wall that would fully cut off any player is illegal.",
              },
            },
            {
              "@type": "Question",
              ...
              acceptedAnswer: {
                "@type": "Answer",
                text: "A casual two-player round usually takes 10–20 minutes. Best-of-five matches take around 30–60 minutes. Four-player games are quicker per round but often more chaotic.",
              },
            },
            {
              "@type": "Question",
              ...
              acceptedAnswer: {
                "@type": "Answer",
                text: "At playquoridor.online. Create a private room and share the code with a friend, use Quick Match, or play a local bot. No account and no download required.",
              },
            },
          ],
        }),
      ...
      <article className="space-y-10">
        <header className="space-y-3">
          ...
          <p className="text-muted-foreground">
            ...
            Each turn you either walk your pawn one square or drop a wall to slow the opponent down.
            First pawn to reach the opposite edge wins. This page is a full reference to the game,
            its rules, its history, and how to play it well — a supplement to the free online
            version you can play at{" "}
            <a className="underline" href="https://playquoridor.online">
              playquoridor.online
            </a>
            .
          </p>
        ...
        <section className="space-y-3">
          ...
          <p>
            ...
            worldwide and has won a long list of awards, including the <em>Mensa Select</em> award
            (1997), the <em>Game of the Year</em> award in the United States (1998), the{" "}
            <em>Toy of the Year</em> in France, Belgium and Canada, and a nomination for the
            prestigious <em>Spiel des Jahres</em>. It is often described online as the "balls and
            walls game", the "wall blocking board game", or the "pawns and fences game" — all of
            which refer to Quoridor.
          </p>
          <p>
            The board is a 9×9 grid of squares. Each player has a single pawn and a personal pool of
            walls (10 in the two-player version, 5 each in the four-player version). Players
            alternate turns. On your turn you must do exactly one of two things: move your pawn one
            square, or place one of your walls. That is the entire rule surface — the depth comes
            from what those two actions imply.
          </p>
        </section>
        ...
        <section className="space-y-3">
          ...
          <ul className="list-disc space-y-1 pl-6">
            <li>
              Board: 9×9 squares (81 in total). Between the squares are 8×8 = 64 potential wall
              slots.
            </li>
            <li>
              Two players: pawns start on the middle square of opposite edges. Each player holds 10
              walls.
            </li>
            <li>
              Four players: pawns start on the middle square of each of the four edges. Each player
              holds 5 walls.
            </li>
            <li>
              Every player's goal is to reach <em>any</em> square on the opposite edge from where
              they started.
            </li>
          </ul>
          ...
          <ul className="list-disc space-y-1 pl-6">
            ...
            <li>
              ...
              placed, a wall stays where it is for the rest of the game — walls are never moved and
              never returned to the reserve.
            </li>
          </ul>
          ...
          <p>
            ...
            version, matches are played as best-of-five rounds by default (first to three round wins
            takes the match), but you can configure the round count when creating a room.
          </p>
        </section>
        ...
        <section className="space-y-3">
          ...
          <ul className="list-disc space-y-2 pl-6">
            <li>
              ...
              race. On every turn, mentally count how many moves each side needs to reach their goal
              assuming no more walls are placed. Whoever has the shorter path is currently winning;
              the person who is behind should look for a wall that lengthens the opponent's path by
              more than it lengthens their own.
            </li>
            <li>
              <strong>Walls are a limited resource.</strong> With only 10 walls in two-player
              Quoridor, every wall you spend must earn its keep. A wall that adds one step to your
              opponent while adding zero to you is worth playing; a wall that adds one to them and
              one to you is a wash.
            </li>
            <li>
              <strong>Threaten, don't just block.</strong> Great walls do two jobs at once: lengthen
              the opponent's path <em>and</em> set up a future forced route (a corridor, a
              bottleneck) where a second wall becomes even more punishing.
            </li>
            <li>
              <strong>Watch for jump traps.</strong> If your pawn ends up adjacent to an opponent
              near a wall, the jump-and-diagonal rules can suddenly give them (or you) an unexpected
              shortcut. Always visualise the jump options before you commit.
            </li>
            <li>
              ...
              through the early game, you enter the endgame with a decisive tool the other player no
              longer has.
            </li>
            <li>
              <strong>Four-player Quoridor is different.</strong> With only 5 walls each, walls are
              precious and it is easy for two players to help each other by accident. Diagonal moves
              and jump interactions come up much more often.
            </li>
          </ul>
        </section>
        ...
        <section className="space-y-3">
          ...
          <dl className="space-y-3">
            ...
            <div>
              ...
              <dd className="text-muted-foreground">
                The minimum number of moves you need to reach your goal edge given the current
                walls.
              </dd>
            </div>
          </dl>
        ...
        <section className="space-y-3">
          ...
          <div>
            ...
            <p className="text-muted-foreground">
              ...
              segments — and search for it as the "balls and walls game" or the "wall blocking board
              game". It is called Quoridor.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-muted-foreground">
              No. On every turn you choose freely between moving your pawn and placing a wall. You
              can play an entire game without ever placing a wall — you just usually won't win
              against a player who does.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-muted-foreground">
              No. The core wall rule is that after any wall placement, every player must still have
              at least one legal path to their goal. A wall that would fully cut off any player is
              illegal and cannot be placed.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-muted-foreground">
              ...
              around 30–60 minutes. Four-player games are quicker per round but often more chaotic.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-muted-foreground">
              ...
              be paired with another player, or fall back to a local bot when nobody is around. No
        ...
        <section className="space-y-3">
          ...
          <p>
            ...
            to create a room, join with a code, or jump into Quick Match. If you want to see how you
            stack up against other players, the{" "}
