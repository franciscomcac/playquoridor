  ...
  head: () => ({
    meta: [
      { title: "Terms of Service · playquoridor.online" },
      {
        name: "description",
        content:
          "The rules for using playquoridor.online — accounts, conduct, moderation, and liability.",
      },
  ...
  return (
    <LobbyChrome>
      <article className="mx-auto max-w-[780px] px-8 pb-16 pt-9 text-[14.5px] leading-[1.7] text-[#c8c8d0]">
        ...
        <p className="mt-6">
          Welcome to <strong>playquoridor.online</strong> ("the site", "we", "us"). By creating an
          account or playing on the site you agree to these Terms. If you disagree, don't use the
          site.
        </p>

        <H2>1. Eligibility</H2>
        <p>
          You must be at least 13 years old (or the minimum age in your country) to use the site. If
          you're under 18 you confirm a parent or guardian is aware you play here.
        </p>
        ...
        <ul className="list-disc space-y-1 pl-5">
          ...
          <li>
            Post sexual content, hate symbols, or violent imagery in your bio, avatar, or chat.
          </li>
        ...
        <p>
          Chat messages, bios, display names, and avatar images are automatically scanned for unsafe
        ...
        <p>
          You keep ownership of what you post (display name, bio, avatar). You grant us a
          non-exclusive, worldwide license to store and display it as needed to run the site.
        </p>

        <H2>6. Availability</H2>
        <p>
          The site is provided "as is". We may change, pause, or discontinue features at any time
          and don't guarantee uninterrupted service.
        </p>

        <H2>7. Liability</H2>
        <p>
          To the maximum extent permitted by law, we're not liable for indirect or consequential
